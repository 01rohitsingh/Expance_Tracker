      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
          ...
          >
            ...
            <Link
              to="/dashboard"
              className="px-3 py-1 rounded-md hover:text-blue-600 active:text-blue-600 active:bg-blue-100 active:scale-95 transition"
            >
              Dashboard
            </Link>
          ...
          >
            ...
            <motion.a
              ...
              className="p-3 rounded-lg bg-slate-100 hover:bg-blue-50 hover:text-blue-600 active:bg-blue-100 active:text-blue-600 active:scale-95 transition"
