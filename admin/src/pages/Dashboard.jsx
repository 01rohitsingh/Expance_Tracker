    ...
    <div className="w-full">
      ...
      {loading ? (
        ...
        <>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6">
            ...
            >
              <div>
                ...
                <p className="text-2xl md:text-3xl font-bold">{data.totalUsers}</p>
              </div>
            ...
            >
              <div>
                <h3 className="text-gray-500 text-sm md:text-base">Transactions</h3>
                <p className="text-2xl md:text-3xl font-bold">{data.totalTransactions}</p>
              </div>
            ...
            >
              <div>
                <h3 className="text-gray-500 text-sm md:text-base">Income</h3>
                <p className="text-2xl md:text-3xl font-bold text-green-600">₹{data.totalIncome}</p>
              </div>
            ...
            >
              <div>
                <h3 className="text-gray-500 text-sm md:text-base">Expense</h3>
                <p className="text-2xl md:text-3xl font-bold text-red-600">₹{data.totalExpense}</p>
              </div>
          ...
          {/* MONTHLY ANALYTICS */}
          <div className="mt-8 bg-white p-6 md:p-8 rounded-xl shadow overflow-x-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-8">
            ...
            <PieChartAnalytics income={data.totalIncome} expense={data.totalExpense} />
          </div>

          {/* RECENT TRANSACTIONS TABLE */}
          <div className="bg-white p-6 md:p-8 rounded-xl shadow mt-8 overflow-x-auto">
              ...
              <tbody>
                {filteredTransactions.map((t) => (
                  <tr key={t._id} className="border-b hover:bg-gray-50">
                    <td className="py-3">{t.user?.name || "Unknown"}</td>
                    <td>₹{t.amount}</td>
