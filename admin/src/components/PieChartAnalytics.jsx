...
/**
 * Format large numbers to K/L/M
 * 1,500 -> 1.5K, 120,000 -> 1.2L, 1,500,000 -> 1.5M
 */
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-lg md:text-xl font-semibold">💹 Income vs Expense</h2>
